...
if(isset($_POST['submit']))
  {
    ...
    $send_email->EmailSend($email,$fname,$lname,$otp);

    $query=mysqli_query($con, "insert into tbluser(FirstName, LastName, MobileNumber, Email, Password, otp_varify) values('$fname', '$lname','$contno', '$email', '$password', $otp)");
    if ($query) {
...
<head>
        <title>Cake Bakery System|| Sign Up</title>
